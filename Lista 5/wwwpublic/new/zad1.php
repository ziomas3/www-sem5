...
<head>
    <meta charset="utf-8">
<style>
.menu1 a {font-size: 20px} /* ustawia rozmair czcionki na 20 */
.menu1 a {text-decoration:none;} /* usuwa dekoracje tekstu np podkreslenia itp*/
.menu1 a {font-family: arial;display:block;background:#eee;padding:4px 20px;margin:2px}/* ustawia marginesy, tło, czcionke, blokowosc itp */
.menu1 li:hover> a {background:#aaa;}/* ustawia ciemniejsze to po najechaniu na rowzwieniete menu  */
.menu1 >li {display:table-cell;padding:0;border:1px solid grey}/* sprawia, że elementy menu pokazuja sie jak komorki tabeli (obok siebie), bez odstepów, z 1px szarą ramką*/
.menu1 >li >a {background:pink; color:white;margin:2px;}/* ustawia rozowe tlo i biale litery z marginesem 2px dla menu nierozwijanego*/
.menu1 >li:hover >a {background:red; }/* ustawia czerwone tlo po najechaniu elementu nierozwijanego*/
.menu1 ul {list-style-type:none} /* usuwa listowanie z podmenu */
.menu1 ul {padding:0} /* usuwa wciecia w podmenu*/
.menu1 li ul {position:absolute;border:1px solid grey;background:#eee}/* sprawia, że menu pokazuje sie nad nastenymi elementami zamiast je przesuwać + zabawy wygladem */
.menu1 li ul {display:none}/* sprawia, że menu rozwijane jest nie widoczne jako stan poczatkowy */
.menu1 li:hover ul {display:block}/* pokazuje menu rozwijane po najechaniu */
.menu1 >li {display:table-cell;padding:0;border:none}/* usuwa ramki i ustawia ze soba elementy menu nierozwijanego*/
